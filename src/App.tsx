...
function App() {
  ...
  const formComponents = [
    <UseForm data={data} updateFieldHandler={updateFieldHandler} />, <ReviewForm data={data} updateFieldHandler={updateFieldHandler} />, <Thanks data={data}/>
  ]
  ...
  return (
    <div className='app'>
      <div className="header">
        ...
        <p>ficamos felizes com sua compra, utitlize o formulário abaixo para valiar o produto.</p>
      </div>
